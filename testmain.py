...
my_scro=Scrollbar(my_canvas, orient=VERTICAL)
my_scro.pack(side=RIGHT,fill=Y)
#---------button deconnection-------
...
labCadre1=Label(frameCadre, text="Villa Assinie Bord de Lagune", font=('Simple', 18, 'bold') )
